...
public class Driver {
  ...
  public static void main(String... args) {
    ...
    SequenceAligner pair = new SequenceAligner("GAGGAATAAC","GACCGAGCC");
    //SequenceAligner pair = new SequenceAligner("A","A", new Judge(3,-3, -1));
    //SequenceAligner pair = new SequenceAligner(12);
    System.out.println(pair);
    System.out.println(pair.getResult(0,2).toString());
